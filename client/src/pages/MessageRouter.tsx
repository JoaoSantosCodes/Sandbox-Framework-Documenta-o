    ...
    <DocsLayout>
      ...
      <div className="container py-12 lg:py-16 max-w-5xl">
        <section className="mb-12">
          <h2 className="font-serif text-2xl font-bold mb-1 scroll-mt-24" id="modos">Modos de publicação <CopySectionButton sectionId="modos" label="Modos de publicação" /></h2>
        ...
        <section className="mb-12">
          <h2 className="font-serif text-2xl font-bold mb-1 scroll-mt-24" id="tabela">Tabela canônica — eventos Event.* <CopySectionButton sectionId="tabela" label="Tabela de eventos" /></h2>
        ...
        <section className="mb-12">
          <h2 className="font-serif text-2xl font-bold mb-1 scroll-mt-24" id="prioridades">Prioridades de assinatura <CopySectionButton sectionId="prioridades" label="Prioridades" /></h2>
        ...
        <section className="mb-12">
          <h2 className="font-serif text-2xl font-bold mb-1 scroll-mt-24" id="invariantes">Invariantes de consumo <CopySectionButton sectionId="invariantes" label="Invariantes" /></h2>
          <p className="text-sm text-muted-foreground mb-5">
        ...
        <section className="mb-4">
          <h2 className="font-serif text-2xl font-bold mb-1 scroll-mt-24" id="fase-18">Contrato da Fase 18 <CopySectionButton sectionId="fase-18" label="Contrato da Fase 18" /></h2>
          <p className="text-sm text-muted-foreground mb-5">
