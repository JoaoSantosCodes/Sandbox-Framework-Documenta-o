...
const DECISIONS: IndexEntry[] = [
  ...
  { id: "DD-15", title: "DD-15 — Atalhos ⌘⇧C e compartilhamento de visualização do histórico", subtitle: "Cópia Markdown de checklist e seções técnicas · share de filtros · Homologada em 14/08/2026", page: "/decisoes", hash: "DD-15", keywords: "dd-15 atalho copiar compartilhar histórico filtros produtividade clipboard", group: "decisoes" },
    { id: "DD-17", title: "DD-17 — Divergência de escopo plano UMG vs. DD-08", subtitle: "Rota A prevalece · DD-08 vigente · escopo de dano mantido · Homologada em 14/08/2026", page: "/decisoes", hash: "DD-17", keywords: "dd-17 divergência escopo umg dano rota a dd-08 vigente f19", group: "decisoes" },
    { id: "DD-18", title: "DD-18 — Linha do Tempo & Roadmap como página permanente", subtitle: "/roadmap · régua de marcos + slots F19 em tempo real · Homologada em 14/08/2026", page: "/decisoes", hash: "DD-18", keywords: "dd-18 roadmap linha do tempo marcos riscos progresso fases timeline", group: "decisoes" },
    { id: "DD-19", title: "DD-19 — Persistência transacional de atributos (rascunho P-2)", subtitle: "/fase-20 · TransactionLog por PredictionId + chave estável + HasAuthority no save · rascunho fora da régua oficial", page: "/decisoes", hash: "DD-19", keywords: "dd-19 persistência save atributos transacional phase 20 v2.0.0 predictionid savgame", group: "decisoes" },
...
const PAGES: IndexEntry[] = [
  ...
  { id: "fase19", title: "Fase 19 (rascunho P-1) — Indicador Direcional de Dano", subtitle: "USBUIDamageIndicator · porta de homologação · DD-08 vigente · rascunho fora da régua oficial", page: "/fase-19", keywords: "fase 19 dano indicador planejamento damage", group: "paginas" },
  ...
  { id: "fase20", title: "Rascunhos — Dano (P-1) & Persistência (P-2)", subtitle: "TransactionLog · PredictionId · checkpoint autorizado · v2.0.0 · rascunho fora do Vault oficial", page: "/fase-20", keywords: "fase 20 planejamento persistência transaction log save checkpoint rollback dd-19 dano p-1 p-2", group: "paginas" },
