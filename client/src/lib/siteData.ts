...
export const PLUGINS: Plugin[] = [
  ...
  { id: "09", name: "SandboxUI", layer: "presentation", dependsOn: ["02", "04"], description: "Gerenciador de camadas USBUIManager e HUD. Lógica completa em desenvolvimento na Fase 18.", status: "stub", version: "1.7.0" },
